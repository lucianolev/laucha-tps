...
\begin{verbatim}
leer archivo y crear 'adyacencias', un arreglo donde cada posicion i es una lista
 de los nodos adyacentes del nodo i.
Luego, hay que eliminar los nodos de grado 0 y de grado 1.
\end{verbatim}
...
\begin{verbatim}
para cada nodo (que llamaremos superNodo) del grafo
  si el taman'o de la lista de adyacencia de superNodo es mayor que 3
    vecindadDeSuperNodo = crearVecindad(superNodo)
    agregar buscarDiamanteMinimoEnVecindad(vecindadDeSuperNodo) a diamantesMinimos
\end{verbatim}
