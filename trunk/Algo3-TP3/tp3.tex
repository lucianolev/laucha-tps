...
\begin{center}
% \includegraphics[width=0.7\textwidth]{graficos6/tiemposBL.png}
\begin{center}
Figura 2.1
\end{center}
\end{center}

En el gráfico se puede apreciar como la curva de orden $(O(n^3))$ acota superiormente a las curvas que representan los resultados de los tiempos de ejecución para los tres tipos de densidades, mientras la curva de orden $(O(n^2))$ la acota inferiormente lo que coincide con los esperado debido a la relación entre $n$ y $m$.
...
densidades disminuye el tiempo requerido. Esto se debe a que al poseer pocas adyacencias un grafo aumenta notablemente la cantidad de posibles soluciones y éstas serán revisadas por el algoritmo a menos que supere la cantidad máxima permitida por la constante pasada como parámetro. Acá se ve la influencia que tiene tambien la variable $m$, más allá de que no esté expresamente representada en el gráfico. 
